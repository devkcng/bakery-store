    ...
    return (
        <div className='container'>
            <div className='pl-2.5'>
                <img
                src={`${
                    itemInfo?.imagePath || "/imgs/bakery-images/muffinb.png"}`}
                alt="" />
            </div>
            <div className='pl-2.5'>
                ...
                <span className="block font-display text-[11px] font-semibold text-[#797B7E] mt-4">
                    {itemInfo?.itemPrice ===0 ? `Đơn giá: ${itemCount*itemInfo.itemPrice} VNĐ` : `Đơn giá: 28000 VNĐ`}    
                </span>
                <span className="block font-display text-[16px] font-semibold text-[#F67575] mb-2">
                    {itemCount*itemInfo.itemPrice < 0 ? "Tổng: 28,000 VNĐ" : `Tổng: ${itemCount*itemInfo.itemPrice} VNĐ`}
                </span>
            </div>
            <div className='pl-4'>
