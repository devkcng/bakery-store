    ...
    <div className="bg-black w-[100%]">
      <div className="flex flex-row items-center justify-around">
        ...
        <div className="flex flex-col mh-[750px] w-[500px] ">
          ...
          <div className="flex flex-col bg-white h-[100%] border border-white items-center justify-center gap-2 py-5 rounded-2xl">
            ...
            <div>
              ...
              <button
                ...
                className="py-[3px] text-[20px] font-bold text-[rgb(147,60,30)]"
              >
