...
const OrderInfoSection:FC<orderInfo> = ({idOrder,idStatus,time,nameBuyer,addressBuyer, phonenumber,note}) => {
    return (
       <div id='container'>
            <div className='flex flex-col items-center mt-10 mb-10 '>
                ...
                <div className='flex flex-row items-end'>
                    ...
                    <label className="block font-display text-[14px] font-semibold text-[#EA5848] mt-2 ml-5">
                        {idStatus ? `| ${idOrder}` : "| Đang cập nhật"}
                    </label>
                </div>
            </div>
            <div className='flex flex-row justify-around mt-10 mb-20 h-auto'>
                <div>
                ...
                <span className="block font-display text-[16px] font-semibold mt-10 mb-5">
                    {nameBuyer ? `Họ và tên người nhận: ${nameBuyer}` : "Họ và tên người nhận: Nguyễn Văn Vũ"}
                </span>
                <span className="block font-display text-[16px] font-semibold mt-1 mb-5">
                    {addressBuyer ? `Địa chỉ người nhận: ${addressBuyer}` : "Địa chỉ người nhận: Số 1, Võ Văn Ngân, Tp. Thủ Đức"}
                </span>
                <span className="block font-display text-[16px] font-semibold mt-1 mb-5">
