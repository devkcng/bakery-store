...
const IngredientDetail: FC<IngredientDetailProp> = ({ detail }) => {
  return (
    <div className="ingredient_container  pt-[20px] flex w-full m-0">
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="w-[400px] font-bold  text-primarycolor text-lg">
              Tên nguyên liệu
            </TableHead>
        ...
        <TableBody>
          {detail.map((details, index) => (
            <TableRow key={index}>
              <TableCell className="w-[150px] ">{details.id || " "}</TableCell>
